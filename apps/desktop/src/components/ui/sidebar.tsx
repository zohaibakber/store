...
export function SidebarMenuBadge({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-lg px-1 font-mono text-xs font-medium text-sidebar-foreground tabular-nums select-none",
