/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.types --env-interface=CloudflareBindings` (hash: b993035c21cc0be459cd7ae3bf0891af)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_TRUSTED_ORIGINS" | "ELECTRON_PROTOCOL">> {}
}
