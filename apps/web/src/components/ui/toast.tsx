...
function CircleAlertIcon(
  ...
  return <HugeiconsIcon icon={HugeAlertCircleIcon} {...props} />;
}

function CircleCheckIcon(
  props: Omit<React.ComponentProps<typeof HugeiconsIcon>, "icon">,
): React.ReactElement {
  return <HugeiconsIcon icon={HugeCheckmarkCircle02Icon} {...props} />;
}
...
function TriangleAlertIcon(
  ...
  return <HugeiconsIcon icon={HugeAlert02Icon} {...props} />;
}
        ...
        {toasts.map((toast) => {
          ...
          return (
            <Toast.Root
              ...
              toast={toast}
            >
              <Toast.Content className="pointer-events-auto flex items-center justify-between gap-1.5 overflow-hidden px-3.5 py-3 text-sm transition-opacity duration-250 [-webkit-app-region:no-drag] data-behind:opacity-0 data-behind:not-data-expanded:pointer-events-none data-expanded:opacity-100">
                {toastData?.progress ? (
                  ...
                  <div className="flex min-w-0 flex-1 gap-2">
                    {Icon && (
                      ...
                      >
                        <Icon
                          aria-hidden="true"
                          className="in-data-[type=error]:text-destructive in-data-[type=info]:text-info in-data-[type=loading]:opacity-80 in-data-[type=success]:text-success in-data-[type=warning]:text-warning"
                        />
                      </div>
                    )}
