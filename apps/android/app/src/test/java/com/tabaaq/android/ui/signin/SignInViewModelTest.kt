...
class SignInViewModelTest {
    ...
    fun successfulPasswordSignInLoadsWorkspace() =
        runTest(dispatcher) {
            ...
            assertThat(repo.state.value).isInstanceOf(com.tabaaq.android.data.auth.AuthState.SignedIn::class.java)
        }
