...
export const makeOfflineStoreApi = (input: {
  ...
  return {
    ...
    deleteCategory: (value) => input.run(storeHandlers.deleteCategory(value)),
    ...
    getProduct: (value) => input.run(storeHandlers.getProduct(value)),
    ...
    deleteProduct: (value) => input.run(storeHandlers.deleteProduct(value)),
    ...
    listStockMovements: (value) => input.run(storeHandlers.listStockMovements(value)),
    listInvoices: () => input.run(storeHandlers.listInvoices()),
    getInvoice: (value) => input.run(storeHandlers.getInvoice(value)),
