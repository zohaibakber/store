...
refresh to Clerk. That kept the first release small, and it also spread
vendor IDs and lifecycle rules through the API, Electron main process, React
renderer, Expo app, synchronization, deployment config, and CSP.
