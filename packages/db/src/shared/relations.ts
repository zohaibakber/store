...
import type * as storeSchema from "./store.schema";

type StoreRelationsBuilder = RelationsBuilder<ExtractTablesFromSchema<typeof storeSchema>>;

export const storeRelations = (r: StoreRelationsBuilder) => ({
  categories: {
