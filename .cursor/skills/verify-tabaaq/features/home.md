...
- Inventory tiles depend on local SQLite. An empty new organization can look sparse; the chrome and the absence of the storage-unavailable paragraph are still proof the route admitted.
