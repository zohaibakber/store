...
Use diagrams to explain relationships and project terminology to name the domain concepts.
...
Use concise language and the project’s established architectural terms.
...
State the evidence, uncertainty, and tradeoffs plainly. Choose prose or bullets to suit the finding.
